...
(function(a) {
	...
	u.formatDate = function(k, t, l) {
		...
		for(r = 0; r < k.length; r++)
			if(f) "'" == k.charAt(r) && !m("'") ? f = !1 : i += k.charAt(r);
		...
		var t = "object" == typeof t ? t.toString() : t + "",
			...
			E = function(a, g, f) {
				...
				for(g = 0; g < a.length; g++)
					if(t.substr(w, a[g].length).toLowerCase() == a[g].toLowerCase()) return w += a[g].length, g + 1;
				return 0
			},
			w = 0,
			y;
		for(y = 0; y < k.length; y++)
			if(h) "'" == k.charAt(y) && !B("'") ? h = !1 : w++;
...
(function(a) {
	var u = a.mobiscroll,
		...
		o = function(o) {
			...
			function g(a, c) {
				if(!a) return !1;
				for(var b = 0, e; b < a.length;)
					if(!(e = a[b++]).invalid) return c ? b - 1 : e;
				return !1
			}
			...
			var f = a.extend({}, k, o.settings),
				...
				K = [],
				D = function(a) {
					for(var c = [], b, e = !0, d = 0; e;)
						if(b = g(a), c[d++] = b.key, e = b.children) a = b.children;
					return c
				}(w),
				D = m(D, A);
			a("#" + h).remove();
